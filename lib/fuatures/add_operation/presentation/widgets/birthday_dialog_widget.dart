...
import 'package:wallefy/fuatures/add_operation/presentation/widgets/lock_up.dart';
...
class _BirthdayDialogState extends State<BirthdayDialog> {
        ...
        Stack(alignment: Alignment.center, children: [
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            PickerWidget(
              ...
              onChange: (index) {
                setState(() {
                  date = DateTime(yearData[index], date.month + 1, date.day);
                  year = yearData[index];
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              child: Text(
                'login.continue',
                style:
                    AppTextStyles.body16w5.copyWith(fontWeight: FontWeight.w500, fontSize: 16, color: AppColors.white),
              ),
            ),
          ),
        ),
  ...
  void setDateTimeLimit() {
    int maxYear = date.year, maxMonth = 12, maxDay = 31, minYear = date.year - 120, minMonth = 1, minDay = 1;
